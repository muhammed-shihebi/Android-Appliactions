 ...
 * RecyclerView access the views via ItemView, therefore it does not care which view is to be displayed.
 */
class TextItemViewHolder(val textView: TextView): RecyclerView.ViewHolder(textView)


/**
 * Takes a quality sleep indicator (integer value) and return the id of the corresponding image resource
 *
 * @param   sleepQuality - integer indicates the quality of the sleep
 *
 * @return  id of the corresponding image resource.
 */
fun getImageId(sleepQuality: Int) : Int {
